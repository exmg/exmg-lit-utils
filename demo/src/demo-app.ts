...
import demoStyles from './demo-app-css.js';

const elements = [
  {name: '@exmg/lit-base'},
  {name: '@exmg/lit-helpers'},
  {name: '@exmg/lit-cli'},
  {name: '@exmg/lit-controllers'},
];
...
export class DemoApp extends LitElement {
  ...
  _updateFromUrl() {
    ...
    if (elementName) {
      ...
      url.searchParams.set('el', this.selectedElement);
      ...
      <main>
        <section>
          ...
          <div class="info">
            ...
            <div class="actions">
              <a href=${`https://www.npmjs.com/package/${this.selectedElement.name}`} target="_blank">
        ...
        <div class="content">
          ...
          <div class="main">
            <iframe src="./demos/${this.selectedElement.name.replace('@exmg/', '')}/index.html"></iframe>
          </div>
        </div>
      </main>
    `;
